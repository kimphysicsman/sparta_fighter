                ...
                if self.ready_bool:
                    ...
                    if ready_time > self.ready_delay:
                        ...
                        if self.attack_mode == 1:
                            ...
                            screen.blit(self.attack_low_ready, (self.x_pos, self.y_pos + self.high_rage + self.middle_rage))
